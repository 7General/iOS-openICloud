...
@interface GZIMTempleteCell: UICollectionViewCell
@end

@implementation GZIMTempleteCell
@end



@interface GZIMCarousel ()<UICollectionViewDelegate, UICollectionViewDataSource> {
...
@end
@implementation GZIMCarousel
@synthesize carouselView = _carouselView;


- (instancetype)initWithFrame:(CGRect)frame delegate:(id<GZIMCarouselDelegate>)delegate datasource:(id<GZIMCarouselDatasource>)datasource flowLayout:(GZIMFlowLayout *)flowLayout {
    CGFloat addHeight = 0;
...
#pragma mark - Setter
- (void)setCustomPageControl:(UIView<GZIMCarouselPageControlProtocol> *)customPageControl {
