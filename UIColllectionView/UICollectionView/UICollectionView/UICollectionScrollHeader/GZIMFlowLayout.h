...
typedef NS_ENUM(NSUInteger, GZIMCarouselStyle) {
...
@interface GZIMFlowLayout : UICollectionViewFlowLayout
/**
 影响轮播图风格
 */
@property (nonatomic, assign) GZIMCarouselStyle style;
...
/**
 ...
 @return 实例对象
 */
- (instancetype)initWithStyle:(GZIMCarouselStyle)style;
@end
